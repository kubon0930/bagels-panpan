...
const steps = [
  {
    ...
    description:
      "営業日、臨時休業、焼き上がり情報はInstagramでお知らせしています。",
  },
  {
    number: "02",
    title: "中板橋のお店へ",
    ...
    <section id="how-to-visit">
      <div className="mx-auto w-full max-w-6xl px-5 py-16 sm:px-8 md:py-24">
        <SectionHeading
          ...
          description="はじめての方も、この3ステップで安心してお越しいただけます。"
        />
            ...
            <Fragment key={step.number}>
              ...
              <div className="flex-1">
                <FadeIn delay={index * 100} className="h-full">
                  <div className="flex h-full flex-col items-center rounded-card border border-wheat/70 bg-soft p-8 text-center shadow-warm">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-block rounded-full bg-crust px-10 py-3.5 font-medium text-cream shadow-warm transition-all hover:-translate-y-0.5 hover:bg-cocoa"
          >
            Instagramを見る
